        ...
        <div className="font-[sans-serif] max-w-7xl mx-auto h-screen">
            <div className="grid md:grid-cols-2 items-center gap-8 h-full">
                <form className="max-w-lg max-md:mx-auto w-full p-6" onSubmit={handleSubmit}>
                    ...
                    <p className="text-sm mt-8 text-center text-[#055c9d]">Don't have an account? <Link to="/register/admin" className="text-[#003060] font-semibold tracking-wide hover:underline ml-1">Register here</Link></p>
                </form>
