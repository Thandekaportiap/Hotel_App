          ...
          <form className="max-w-4xl mx-auto bg-white shadow-[0_2px_13px_-6px_rgba(0,0,0,0.4)] sm:p-8 p-4 rounded-md">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <input name="company" type="text" className="bg-gray-100 focus:bg-transparent w-full text-sm text-gray-800 px-4 py-3 rounded-md outline-blue-500 transition-all" placeholder="Enter company name" />
              </div>
              <div>
              ...
              <div>
                ...
                <input name="profilePicture" type="file" accept="image/*" className="bg-gray-100 focus:bg-transparent w-full text-sm text-gray-800 px-4 py-3 rounded-md outline-blue-500 transition-all" />
              </div>
            </div>
            <div className="mt-8">
              <button type="button" className="py-3 px-6 text-sm tracking-wider font-semibold rounded-md text-white bg-[#003060] hover:bg-blue-600 focus:outline-none">
                Sign up
              </button>
            </div>
          </form>
